...
<!---Documatic-section-aws_ssh_config.generate_id-start--->
## aws-ssh-config.generate_id

<!---Documatic-section-generate_id-start--->
<!---Documatic-block-aws_ssh_config.generate_id-start--->
<details>
	<summary><code>aws_ssh_config.generate_id</code> code snippet</summary>
...
<!---Documatic-block-aws_ssh_config.generate_id-end--->
<!---Documatic-section-generate_id-end--->

# #
<!---Documatic-section-aws_ssh_config.generate_id-end--->

<!---Documatic-section-aws_ssh_config.main-start--->
## aws-ssh-config.main

<!---Documatic-section-main-start--->
```mermaid
flowchart LR
aws-ssh-config.main-->aws-ssh-config.generate_id
```
...
<!---Documatic-block-aws_ssh_config.main-start--->
<details>
	<summary><code>aws_ssh_config.main</code> code snippet</summary>
...
def main():
    ...
    for region in boto.ec2.regions():
        ...
        for instance in conn.get_only_instances():
            ...
            elif not instance.image_id in amis:
...
<!---Documatic-block-aws_ssh_config.main-end--->
<!---Documatic-section-main-end--->

# #
<!---Documatic-section-aws_ssh_config.main-end--->
